...
class MusicPlayer:
    def __init__(self):
        ...
        title_bar = tk.Frame(self.window, bg='#1A1A1A', relief='flat', bd=0)
        ...
        # Minimize button
        minimize_button = tk.Button(title_bar,
                                  text="─",
                                  font=('Arial', 11),
                                  bg='#1A1A1A',
                                  fg='#FFFFFF',
        ...
        for button in [close_button, minimize_button]:
            def on_enter(e, btn=button):
                if btn == close_button:
                    btn.configure(bg='#E81123')  # Red for close
                else:
                    btn.configure(bg='#333333')  # Dark grey for minimize
        ...
        title_frame.pack(pady=(0, 30))  # Increased bottom padding to compensate for removed subtitle
        ...
        left_decor.pack(side=tk.LEFT, padx=10)
        ...
        right_decor = tk.Label(title_frame, 
                              ...
                              bg='#1E1E1E',
                              fg='#4CAF50')  # Green color
        right_decor.pack(side=tk.LEFT, padx=10)
        ...
        self.search_frame.pack(fill='x', pady=(0, 25))  # Increased bottom padding
        ...
        self.buttons_frame.pack(pady=20)  # Increased padding
        ...
        # Volume Frame with better styling
        volume_frame = tk.Frame(controls_frame, bg='#1E1E1E')
        volume_frame.pack(pady=15)

        # Create a container for volume controls with grey background
        volume_container = tk.Frame(volume_frame, bg='#2D2D2D', padx=20, pady=15)  # Increased padding
        ...
        self.volume_button.pack(side=tk.LEFT, padx=(0, 10))
        ...
        self.volume_slider = tk.Scale(volume_container,
                                    ...
                                    sliderrelief='flat',
                                    bd=0,
                                    width=15,  # Increased height
                                    showvalue=False,
                                    command=self.set_volume)

        # Set initial volume
        self.volume_slider.set(current_vol)
        self.volume_slider.pack(side=tk.LEFT, padx=(10, 15), pady=8)  # Adjusted padding
